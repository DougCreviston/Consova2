...
namespace LynxLib
{
    public class LDBSQL
    {
        ...
        private string _queryField(string field)
        {
            ...
            {
                using (SqlConnection con = new SqlConnection(LynxLib.Properties.Resources.ldbConnStr))
                {
                    con.Open();
        ...
        { 
                ...
                SqlConnection con = new SqlConnection(LynxLib.Properties.Resources.ldbConnStr);
                try
                {
