...
namespace LynxLib
{
    public class SMS
    {
        ...
        public int send()
        {
            ...
            string str = "INSERT INTO from_threadpool(phone,Carrier) VALUES('" + _phonenumber + "','begin send')";
            SQL2.edit("INSERT INTO from_threadpool(phone,Carrier) VALUES('" + _phonenumber + "','begin send')");
            try
            {
                ...
                source.SetAttribute("ton", "3");
                source.SetAttribute("address", _sourceNum);
                XmlElement option = doc.CreateElement("option");
                option.SetAttribute("program_id", "1822191");
                ...
                if (_carrier != "")
                {
                    destination.SetAttribute("carrier", _carrier);
                }
                ...
                message.SetAttribute("text", _xmessage);
                ...
                using (XmlReader reader = XmlReader.Create(new StringReader(xmlResult)))
                {
                    ...
                    SQL2.edit("INSERT INTO from_threadpool(phone,Carrier) VALUES('" + _phonenumber + "','Insert into TextHistory')");
                    lock (SQL)
                    {
                        sent = SQL.edit("INSERT INTO TextHistory (ErrorCode,ErrorDesc,TicketID,Source,STON,Destination,DTON,Carrier,Date,Time,Message,XML) VALUES ('" + code + "','" + desc + "','" + id + "','" + _sourceNum + "','3','" + _phonenumber + "','0','" + _carrier + "',Convert(char(10),getDate(),110),'" + DateTime.Now.TimeOfDay.ToString() + "','" + _xmessage.Replace("'", "''") + "','" + postData.Replace("'", "''") + "')");
