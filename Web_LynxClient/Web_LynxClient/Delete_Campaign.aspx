<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Delete_Campaign.aspx.cs" Inherits="Web_LynxClient.Delete_Campaign" %>
...
<body>
   ...
   <div class="header">
    ...
    <asp:label id="page_title" runat="server" Text="Available Campaigns"></asp:label>
    </div>
